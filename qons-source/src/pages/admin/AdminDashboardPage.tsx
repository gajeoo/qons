        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                {
                  label: "Starter Plan ($45.99/mo)",
                  count: subStats?.starterCount ?? 0,
                  revenue: (subStats?.starterCount ?? 0) * 4599,
                  color: "bg-chart-1",
                },
                {
                  label: "Pro Plan ($95.99/mo)",
                  count: subStats?.proCount ?? 0,
                  revenue: (subStats?.proCount ?? 0) * 9599,
                  color: "bg-teal",
                },
                {
                  label: "Business Plan ($140.99/mo)",
                  count: subStats?.enterpriseCount ?? 0,
                  revenue: (subStats?.enterpriseCount ?? 0) * 14099,
                  color: "bg-chart-4",
                },
              ].map(item => (
                <div key={item.label} className="flex items-center gap-3">
