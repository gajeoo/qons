            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  operational inefficiency. Working alongside property
                  management and concierge companies, he saw the same pattern
                  everywhere: talented operators drowning in manual scheduling,
                  disconnected tools, and zero real-time visibility.
                </p>
                <p>
                ...
                <p>
                  ...
                  <span className="text-foreground font-medium">
                    what if AI could handle the operations, so people could
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              board deserves the same AI-powered tools that Fortune 500
