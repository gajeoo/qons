...
const roleColors: Record<string, string> = {
  ...
  porter: "bg-purple-100 text-purple-700",
...
function StaffPageInner() {
  ...
  const allRoles = ([
    ...new Set(staffList.map(s => String(s.role))),
  ].sort() as string[]);
  ...
  const openEdit = (s: (typeof staffList)[0]) => {
    setForm({
      ...
      maxHoursPerWeek: String(s.maxHoursPerWeek || 40),
      hireDate: s.hireDate || "",
      notes: s.notes || "",
    });
    setEditingId(s._id);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your team members, availability, and certifications
          </p>
        </div>
        <Button
          onClick={openCreate}
            ...
            >
              ...
              <CardContent className="pt-0 space-y-3">
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className={roleColors[s.role] || defaultRoleColor}>
                    {s.role}
                  </Badge>
                </div>
                ...
                {s.certifications && s.certifications.length > 0 && (
                  <div className="flex flex-wrap gap-1">
                    {s.certifications.map(c => (
                      <span
                        key={c}
                        className="text-[10px] px-1.5 py-0.5 rounded bg-blue-50 text-blue-600 flex items-center gap-0.5"
                      >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="CPR, First Aid, Fire Safety"
              />
            </div>
            <div>
              ...
              <Input
                ...
                placeholder="Front desk, Package handling, Access control"
              />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
            ...
            <div className="flex gap-3 justify-end pt-2">
              ...
              <Button
                ...
                className="bg-teal text-white hover:bg-teal/90"
                disabled={
                  !form.name || !form.email || !form.role || !form.hourlyRate
                }
              >
