          ...
          {isInvite && validInvite ? (
            <>
              ...
              <p className="text-muted-foreground text-sm">
                {invitation.inviterName ? `${invitation.inviterName} invited you` : "You've been invited"} as a{" "}
                <Badge variant="outline" className="gap-1 ml-1 capitalize">
                  {invitation.role === "manager" ? <Crown className="size-3 text-amber-500" /> : <Wrench className="size-3 text-green-500" />}
                  {invitation.role}
                </Badge>
              </p>
            ...
            <>
              ...
              <p className="text-muted-foreground text-sm">
                This invitation is no longer valid. Ask your manager to send a new one, or sign up for a free trial.
              </p>
            </>
          ) : (
            <>
              ...
              <Badge variant="outline" className="gap-1 text-teal border-teal/30 bg-teal/5">
